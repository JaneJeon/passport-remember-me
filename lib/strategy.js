...
function Strategy (options, verify, issue) {
  ...
  if (!verify)
    throw new Error(
      'remember me cookie authentication strategy requires a verify function'
    )
  if (!issue)
    throw new Error(
      'remember me cookie authentication strategy requires an issue function'
    )
...
Strategy.prototype.authenticate = function (req, options) {
  ...
  var token = req.cookies[this._key] || req.session[this._key]
